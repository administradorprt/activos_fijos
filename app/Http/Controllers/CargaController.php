...
class CargaController extends Controller
{
    ...
    {
        $respuesta='';
    	return view('inventario.Carga.index_eqc', ["Respuesta"=>$respuesta]);
    }
        ...
        try {
            ...
            if($errors!=''){
                ...
                foreach ($fila as $row) {
                    ...
                    $Equipo->num_equipo='EQC-'.$Equipo->id_equipo_computo;
		            $Equipo->update();
                    $registros++;
                }              
                    $respuesta[0] = true;
    ...
    {
    	$respuesta='';
    	return view('inventario.Carga.index_moe', ["Respuesta"=>$respuesta]);
    }
