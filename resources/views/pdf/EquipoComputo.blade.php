...
<div>
   ...
   {{$EquipoComputo->empleado->nombre}} {{$EquipoComputo->empleado->apellido_paterno}} {{$EquipoComputo->empleado->apellido_materno}}</label>
</div>
<div>
	<strong> <label for="">Número del Equipo:</strong>
   {{$EquipoComputo->num_equipo}} </label>
</div>
<div>
	<strong> <label for="">Marca:</strong>
   {{$EquipoComputo->marca}} </label>
</div>
<div>
	<strong> <label for="">modelo:</strong>
   {{$EquipoComputo->modelo}} </label>
</div>
<div>
	<strong> <label for="">Color:</strong>
   {{$EquipoComputo->color}} </label>
</div>
<div>
	<strong> <label for="">Tipo:</strong>
   {{$EquipoComputo->tipos->nombre}} </label>
</div>
<div>
	<strong> <label for="">Detalles:</strong>
   {{$EquipoComputo->descripcion}} </label>
</div>

<div>
	<strong> <label for="">Observaciones:</strong>
   {{$EquipoComputo->observaciones}} </label>
</div>
<br>
<div ALIGN="justify" >
...
<div>{{$EquipoComputo->empleado->nombre}} {{$EquipoComputo->empleado->apellido_paterno}} {{$EquipoComputo->empleado->apellido_materno}}</div>
<br>
