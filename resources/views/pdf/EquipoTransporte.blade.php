...
<div>
   ...
   {{$EquipoTransporte->empleado->nombre}} {{$EquipoTransporte->empleado->apellido_paterno}} {{$EquipoTransporte->empleado->apellido_materno}}</label>
</div>
<div>
	<strong> <label for="">Número del Equipo:</strong>
   {{$EquipoTransporte->num_equipo}} </label>
</div>
<div>
	<strong> <label for="">Marca:</strong>
   {{$EquipoTransporte->marca}} </label>
</div>
<div>
	<strong> <label for="">modelo:</strong>
   {{$EquipoTransporte->modelo}} </label>
</div>
<div>
	<strong> <label for="">Color:</strong>
   {{$EquipoTransporte->color}} </label>
</div>
<div>
	<strong> <label for="">Tipo:</strong>
   {{$EquipoTransporte->tipos->nombre}} </label>
</div>
<div>
	<strong> <label for="">Detalles:</strong>
   {{$EquipoTransporte->descripcion}} </label>
</div>
<div>
	<strong> <label for="">Observaciones:</strong>
   {{$EquipoTransporte->observaciones}} </label>
</div>
<br>
<div ALIGN="justify" >
...
<div>{{$EquipoTransporte->empleado->nombre}} {{$EquipoTransporte->empleado->apellido_paterno}} {{$EquipoTransporte->empleado->apellido_materno}}</div>
<br>
