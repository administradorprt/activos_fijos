...
<div>
   ...
   {{$EquipoTransporte->empleado->nombres}} {{$EquipoTransporte->empleado->apellido_p}} {{$EquipoTransporte->empleado->apellido_m}}</label>
</div>
<div>
...
<div>{{$EquipoTransporte->empleado->nombres}} {{$EquipoTransporte->empleado->apellido_p}} {{$EquipoTransporte->empleado->apellido_m}}</div>
<br>
