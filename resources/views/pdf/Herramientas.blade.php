...
<div>
   ...
   {{$Herramientas->num_equipo}} </label>
</div>
<div>
	<strong> <label for="">Marca:</strong>
   {{$Herramientas->marca}} </label>
</div>
<div>
	<strong> <label for="">modelo:</strong>
   {{$Herramientas->modelo}} </label>
</div>
<div>
	<strong> <label for="">Color:</strong>
   {{$Herramientas->color}} </label>
</div>
<div>
	<strong> <label for="">Tipo:</strong>
   {{$Herramientas->tipos->nombre}} </label>
</div>
<div>
	<strong> <label for="">Detalles:</strong>
   {{$Herramientas->descripcion}} </label>
</div>
<div>
	<strong> <label for="">Observaciones:</strong>
   {{$Herramientas->observaciones}} </label>
</div>
<br>
<div ALIGN="justify" >
