...
<div>
   ...
   {{$MaquinariaEquipo->empleado->nombre}} {{$MaquinariaEquipo->empleado->apellido_paterno}} {{$MaquinariaEquipo->empleado->apellido_materno}}</label>
</div>
<div>
	<strong> <label for="">Número del Equipo:</strong>
   {{$MaquinariaEquipo->num_equipo}} </label>
</div>
<div>
	<strong> <label for="">Marca:</strong>
   {{$MaquinariaEquipo->marca}} </label>
</div>
<div>
	<strong> <label for="">modelo:</strong>
   {{$MaquinariaEquipo->modelo}} </label>
</div>
<div>
	<strong> <label for="">Color:</strong>
   {{$MaquinariaEquipo->color}} </label>
</div>
<div>
	<strong> <label for="">Tipo:</strong>
   {{$MaquinariaEquipo->tipos->nombre}} </label>
</div>
<div>
	<strong> <label for="">Detalles:</strong>
   {{$MaquinariaEquipo->descripcion}} </label>
</div>
<div>
	<strong> <label for="">Observaciones:</strong>
   {{$MaquinariaEquipo->observaciones}} </label>
</div>
<br>
<div ALIGN="justify" >
...
<div>{{$MaquinariaEquipo->empleado->nombre}} {{$MaquinariaEquipo->empleado->apellido_paterno}} {{$MaquinariaEquipo->empleado->apellido_materno}}</div>
<br>
