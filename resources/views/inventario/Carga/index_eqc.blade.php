...
@section('contenido')
	<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
			<h1>Carga Masiva de activos de cómputo</h1>
		</div>
	</div>
	<div class="row">
	...
	<div class="row">
		<div class="col-lg-10 col-md-10 col-sm-6 col-xs-12">
			...
			<div class="">
				<div class="row ">
					<form id='frm_up_xls_multi_compu' action="{{ route('ImportarComputo') }}" method="POST" enctype="multipart/form-data">
						{{Csrf_field()}}
								...
								<div class="panel-body">
									<p>
										<div class="form-group">
											<label for="giro">Categoria Equipo de Cómputo</label>
											<input type="file" name="archivo_excel" id='archivo_excel' class="form-control" accept=".xls,.xlsx" >
										</div>
										<div class="form-group">
										<!--	<button class="btn btn-success" type="submit" >Guardar</button>-->
											<button  id='btn_subir_excel_masivo_compu' class="btn btn-success" type="button" >Guardar</button>
										</div>
									</p>
								</div>
							</div>
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<p>
									...
									<div class="form-group">
										<A href="{{asset('archivos/inventario/EquipoComputo/layout/Layout_equipo_computo.xlsx')}}" ><input type="button"  class="form-control btn-primary" value="Descargar"></A>
									</div>
									<div class="form-group">
										Recomendaciones: 
										<br><br>
