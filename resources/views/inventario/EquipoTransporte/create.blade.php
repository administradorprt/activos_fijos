...
<div class="row">
	<div class="col-lg-10 col-md-10 col-sm-6 col-xs-12">
		<h3>Nuevo Equipo de Transporte</h3>
		@if(count($errors)>0)
		...
		@endif
			<form action="{{route('EquipoTransporte.store')}}" method="post" autocomplete="off" files="true" enctype="multipart/form-data">
				@csrf
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="form-group">
							...
							<input type="text" name="vin" class="form-control" placeholder="Vin" maxlength="17" required value="{{old('vin')}}">
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="form-group">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="form-group">
							...
							<input type="text" name="num_motor" class="form-control" placeholder="Numero de Motor" value="{{old('num_motor')}}" required>
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="form-group">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="form-group">
							...
							<input type="text" name="nombre_provedor" class="form-control" placeholder="nombre_provedor" value="{{old('nombre_provedor')}}" required>
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="form-group">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="form-group">
							...
							<input type="text" name="num_factura" class="form-control" placeholder="num_factura" value="{{old('num_factura')}}" required>
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="form-group">
							<label for="fecha_compra">Fecha de Compra</label>
							<input type="date" name="fecha_compra" class="form-control" value="{{old('fecha_compra')}}" placeholder="yyyy-mm-dd" required>
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="form-group">
