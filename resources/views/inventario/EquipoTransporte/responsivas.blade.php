...
<div class="row">
	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
		<h1>Responsiva de Equipos de transporte </h1>
	</div>
</div>
<div class="row">
	<div class="clo-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="table-responsive">
			<form action="{{route('EquipoTransporte.Responsivas.post')}}" method="post">
				@csrf
			...
			{{-- {{ Form::Open(array('url'=>'admin/inventario/EquipoTransporte/Responsivas','method'=>'post'))}}
			{{Form::Close()}} --}}
		</div>
	</div>
</div>
