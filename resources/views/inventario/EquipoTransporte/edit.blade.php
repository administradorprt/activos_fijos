	...
	<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
		...
		<form action="{{route('EquipoTransporte.update',$EquipoTransporte->id_equipo_transporte)}}" method="post" enctype="multipart/form-data">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					...
					<input type="text" name="descripcion" class="form-control" placeholder="Descripcion" value="{{$EquipoTransporte->descripcion}}">
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					<label for="marca">Marca</label>
					<input type="text" name="marca" class="form-control" placeholder="Marca" value="{{$EquipoTransporte->marca}}">
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					...
					<input type="text" name="modelo" class="form-control" placeholder="Modelo" value="{{$EquipoTransporte->modelo}}">
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					<label for="num_motor">Número de Motor</label>
					<input type="text" name="num_motor" class="form-control" placeholder="Numero de Motor" value="{{$EquipoTransporte->num_motor}}">
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					<label for="color">Color</label>
					<input type="text" name="color" class="form-control" placeholder="Color" value="{{$EquipoTransporte->color}}">
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					...
					<input type="text" name="costo" class="form-control" placeholder="costo" value="{{$EquipoTransporte->costo}}">
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					<label for="nombre_provedor">Nombre del Proveedor</label>
					<input type="text" name="nombre_provedor" class="form-control" placeholder="nombre_provedor" value="{{$EquipoTransporte->nombre_provedor}}">
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					<label for="id_proveedor">ID del Proveedor</label>
					<input type="text" name="id_proveedor" class="form-control" placeholder="id_proveedor" value="{{$EquipoTransporte->id_proveedor}}">
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					<label for="numero_de_pedido">Número de pedido</label>
					<input type="text" name="numero_de_pedido" class="form-control" placeholder="numero_de_pedido" value="{{$EquipoTransporte->numero_de_pedido}}">
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					<label for="num_factura">Número de Factura</label>
					<input type="text" name="num_factura" class="form-control" placeholder="num_factura" value="{{$EquipoTransporte->num_factura}}">
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					<label for="fecha_compra">Fecha de Compra</label>
					<input type="date" name="fecha_compra" class="form-control" placeholder="fecha_compra" value="{{$EquipoTransporte->fecha_compra}}">
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					<label for="fecha_vida_util_inicio">fecha de inicio de vida util</label>
					<input type="date" name="fecha_vida_util_inicio" class="form-control" placeholder="fecha_vida_util_inicio" value="{{$EquipoTransporte->fecha_vida_util_inicio}}">
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					<label for="fecha_depreciacion_inicio">fecha de inicio de depreciación</label>
					<input type="date" name="fecha_depreciacion_inicio" class="form-control" placeholder="fecha_depreciacion_inicio" value="{{$EquipoTransporte->fecha_depreciacion_inicio}}">
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					...
					@if($EquipoTransporte->carta_responsiva!="")
						<A HREF="{{asset('archivos/inventario/EquipoTransporte/carta_responsiva/'.$EquipoTransporte->carta_responsiva)}}" target="_blank"><input type="button"  class="form-control" value="ver carta_responsiva"></A>
					@else
		...
		@if(auth()->user()->role_id == 1)
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					...
					<input type="text" name="tasa_depreciacion" class="form-control" placeholder="tasa_depreciacion" value="{{$EquipoTransporte->tasa_depreciacion}}">
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					<label for="vida_util">Meses de Vida Util</label>
					<input type="text" name="vida_util" class="form-control" placeholder="vida_util" value="{{$EquipoTransporte->vida_util}}">
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					<label for="precio_venta">Precio de venta</label>
					<input type="text" name="precio_venta" class="form-control" placeholder="precio_venta" value="{{$EquipoTransporte->precio_venta}}">
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					<label for="fecha_baja">Fecha de Baja</label>
					<input type="date" name="fecha_baja" class="form-control" placeholder="fecha_baja" value="{{$EquipoTransporte->fecha_baja}}">
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					<label for="motivo_baja">Motivo de Baja</label>
					<input type="text" name="motivo_baja" class="form-control" placeholder="motivo_baja" value="{{$EquipoTransporte->motivo_baja}}">
				</div>
			</div>
		@endif
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					...
					<input type="text" name="observaciones" class="form-control" placeholder="observaciones" value="{{$EquipoTransporte->observaciones}}">
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					<label for="garantia">Garantía</label>
					<input type="text" name="garantia" class="form-control" placeholder="garantia" value="{{$EquipoTransporte->garantia}}">
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					...
					<select name="estatus_depreciacion" class="form-control" >
						@foreach($Depreciacion as $estado_dep )
							@if($estado_dep->id_status== $EquipoTransporte->estatus_depreciacion)
			...
			<div class="box-footer clearfix">
				<button type="button" class="pull-left btn btn-danger pr-2 btn_delete_img_tra" id="btn_del_img_seminuevo"> Eliminar imagenes Selecionadas <i class="fa fa-times"></i></button>
			</div>
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
				...
				<a href="/admin/inventario/EquipoTransporte"><button class="btn btn-danger" type="button" >Cancelar</button></a>
			</div>
		</div>
		</form>
