		...
		<form action="{{route('MobiliarioEquipo.show',$MobiliarioEquipo->id)}}" method="get" enctype="multipart/form-data">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					...
					value="@if($MobiliarioEquipo->estado==1)Activo
					@else Inactivo
					@endif" readonly="">
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					...
					<textarea class="form-control" name="descripcion"  cols="30" rows="5" readonly="">{{$MobiliarioEquipo->descripcion}}</textarea>
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					<label for="marca">Marca</label>
					<input type="text" name="marca" class="form-control" placeholder="Marca" value="{{$MobiliarioEquipo->marca}}" readonly="">
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					<label for="serie">Número de Serie</label>
					<input type="text" name="serie" class="form-control" placeholder="serie"  required  value="{{$MobiliarioEquipo->serie}}" readonly="">
				</div>
			</div>
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<input type="text" name="modelo" class="form-control" placeholder="Modelo" value="{{$MobiliarioEquipo->modelo}}" readonly="">
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						<label for="medida">Medida</label>
						<input type="text" name="medida" class="form-control" placeholder="Medida" value="{{$MobiliarioEquipo->medida}}" readonly="">
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						<label for="color">Color</label>
						<input type="text" name="color" class="form-control" placeholder="Color" value="{{$MobiliarioEquipo->color}}" readonly="">
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<input type="text" name="costo" class="form-control" placeholder="costo" value="{{$MobiliarioEquipo->costo}}" readonly="">
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						<label for="nombre_provedor">Nombre del Proveedor</label>
						<input type="text" name="nombre_provedor" class="form-control" placeholder="nombre_provedor" value="{{$MobiliarioEquipo->nombre_provedor}}" readonly="">
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						<label for="id_proveedor">id proveedor</label>
						<input type="text" name="id_proveedor" class="form-control" placeholder="id_proveedor" value="{{$MobiliarioEquipo->id_proveedor}}" readonly="">
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						<label for="numero_de_pedido">Número de pedido</label>
						<input type="text" name="numero_de_pedido" class="form-control" placeholder="numero_de_pedido" value="{{$MobiliarioEquipo->numero_de_pedido}}" readonly="">
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						<label for="num_factura">Número Factura</label>
						<input type="text" name="num_factura" class="form-control" placeholder="num_factura" value="{{$MobiliarioEquipo->num_factura}}" readonly="">
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						<label for="fecha_compra">Fecha de Compra</label>
						<input type="date" name="fecha_compra" class="form-control" placeholder="fecha_compra" value="{{$MobiliarioEquipo->fecha_compra}}" readonly="">
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						<label for="fecha_vida_util_inicio">fecha de inicio de vida util</label>
						<input type="date" name="fecha_vida_util_inicio" class="form-control" placeholder="fecha_vida_util_inicio" value="{{$MobiliarioEquipo->fecha_vida_util_inicio}}" readonly="">
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						<label for="fecha_depreciacion_inicio">fecha de inicio de depreciacion</label>
						<input type="date" name="fecha_depreciacion_inicio" class="form-control" placeholder="fecha_depreciacion_inicio" value="{{$MobiliarioEquipo->fecha_depreciacion_inicio}}" readonly="">
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<input type="text" name="tasa_depreciacion" class="form-control" placeholder="tasa_depreciacion" value="{{$MobiliarioEquipo->tasa_depreciacion}}" readonly="">
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						<label for="vida_util">Meses de Vida Util</label>
						<input type="text" name="vida_util" class="form-control" placeholder="vida_util" value="{{$MobiliarioEquipo->vida_util}}" readonly="">
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<input type="date" name="fecha_baja" class="form-control" placeholder="fecha_baja" value="{{$MobiliarioEquipo->fecha_baja}}" readonly="">
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						<label for="motivo_baja">Motivo de Baja</label>
						<input type="text" name="motivo_baja" class="form-control" placeholder="motivo_baja" value="{{$MobiliarioEquipo->motivo_baja}}" readonly="">
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						<label for="observaciones">Observaciones</label>
						<input type="text" name="observaciones" class="form-control" placeholder="observaciones" value="{{$MobiliarioEquipo->observaciones}}" readonly="">
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						<label for="garantia">Garantia</label>
						<input type="text" name="garantia" class="form-control" placeholder="garantia" value="{{$MobiliarioEquipo->garantia}}" readonly="">
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<input type="text" name="precio_venta" class="form-control" placeholder="precio_venta" value="{{$MobiliarioEquipo->precio_venta}}" readonly="">
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						<label for="estatus_depreciacion">estado de depreciacion</label>
						<input type="text" name="estatus_depreciacion" class="form-control" placeholder="estatus_depreciacion" value="{{$MobiliarioEquipo->estadodepreciacion->nombre}}" readonly="">
					</div>
				</div>
				<div class="container">
					<div class="row ">
				...
				<div class="form-group">
					...
					<a href="/admin/inventario/MobiliarioEquipo"><button class="btn btn-danger" type="button" >Atras</button></a>
				</div>
				<div class="form-group">
					<!--<button class="btn btn-primary" type="submit" >Actualizar</button>-->
