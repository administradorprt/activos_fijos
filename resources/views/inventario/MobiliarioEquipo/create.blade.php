...
<div class="row">
	<div class="col-lg-10 col-md-10 col-sm-6 col-xs-12">
		<h3>Nuevo Mobiliario y Equipo de Oficina</h3>
		@if(count($errors)>0)
		...
		@endif
		<form action="{{route('MobiliarioEquipo.store')}}" method="post" autocomplete="off" enctype="multipart/form-data">
			@csrf
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<input type="date" name="fecha_compra" class="form-control" placeholder="fecha_compra" required value="{{old('fecha_compra')}}">
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
